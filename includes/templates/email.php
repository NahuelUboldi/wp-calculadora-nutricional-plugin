...
function createList($array,$imc,$text_color) {
	...
	foreach ($array as $key => $value) {
		...
		if($imc >= $min && $imc <= $max) {
			$result .= "
			<li style='font-size:1.3rem;line-height:2rem;'>
				<span style='font-size:1.3rem;line-height:2rem;color:{$color};-webkit-text-stroke-width: 1.3px;-webkit-text-stroke-color: white;'>► ⬤ </span>
				<span style='font-size:1.3rem;line-height:2rem;color:{$text_color}'>{$text} </span>
			</li>";
		} else {
			$result .= "
			<li style='color:{$text_color};opacity:0.5;font-size:1.3rem;line-height:2rem;'>
				<span style='font-size:1.3rem;line-height:2rem;visibility:hidden;opacity:0;'> ► </span>
				<span style='font-size:1.3rem;line-height:2rem;'>
					⬤ {$text}
				</span>
			</li>";
		}
	...
	<table cellpadding='0' cellspacing='0' border='0' id='backgroundTable' style='background:#eee;'>
		<tr>
			<td>
				...
				<!-- USER DATA TABLE -->
				<table cellpadding='0' cellspacing='0' border='0' align='center' role='presentation' style='width:100%;border:solid 1px white;background:{$colors["bg-dark"]};color:white; margin:5px auto;{$rounded_borders}'>
					<tr style='border:none;'>
						<td class='block' align='center' valign='center' style='padding:20px;font-weight:bold;font-size:1.3rem;line-height:2rem;border:none;'>
							<h1 class='font-size:1.5rem;margin:0px;padding:0px;'><span style='color:white;line-height:3rem;'>Estudio Corporal Virtual</span></h1>
						</td>
					</tr>
					<tr>
						<td class='block' align='left' valign='center' style='padding:1%;' >

							<!--inner table start -->
							<table border='0' align='center' role='presentation' style='width:98%;margin-bottom: 10px;border-collapse: separate;border-spacing: 15px;border:none;'>
								<tr style='border:none;'>
								...
								<tr style='border:none;'>
									<td class='block' align='center' valign='center' style='padding:1%;margin-bottom:4%;background:white;{$rounded_borders};color:{$colors['bg-dark']}'>
										<p style='font-weight:bold;font-size:1.3rem;line-height:2rem;margin:0;'>
											Edad: {$edad}
										</p>
									</td>
				...
				<!--PESO / IMC TABLE -->
				<!--table start -->
				<table cellpadding='0' cellspacing='0' border='0' align='center' role='presentation' style='width:100%;border:solid 1px white;{$rounded_borders}background:{$colors["$sexo"]}; margin:5px auto'>
					<tr style='border:none;;'>
						<td class='block' align='left' valign='center' style='padding:1%; border:none; ' width='20%'>
															
							<!--inner table start -->
							<table border='1' align='center' role='presentation' style='border:none;width:98%;margin-bottom: 10px;background:white;color:black; margin:5px auto;{$rounded_borders}'>
							...
							<!--inner table start -->
							<table border='1' align='center' valign='center' role='presentation' style='border:none;width:98%;margin-bottom: 10px;background:white;color:black; margin:5px auto;{$rounded_borders}'>
								...
								<tr style='border:none;background:{$imc_color}'>
									<td align='center' valign='center' style='padding:1%;border:none;'>
										<p style='font-weight:bold;font-size:1.3rem;line-height:2rem;margin:0;text-shadow:1px 1px 0 #fff,-1px 1px 0 #fff,-1px -1px 0 #fff,1px -1px 0 #fff;'>
											{$imc}
									</td>
								</tr>
							</table>
						...
						<td class='block' align='left' valign='center' style='padding:1%;' width='100%'>
							<ul style='list-style:none;font-weight:bold;margin:0 2%;line-height:2rem;'>
							{$imc_list}
							</ul>
						</td>
					</tr>
				...
				<!--GRASA TABLE -->
				<!--table start -->
				<table cellpadding='0' cellspacing='0' border='0' align='center' role='presentation' style='width:100%;border:solid 1px white;{$rounded_borders}background:{$colors['bg-light']}; margin:5px auto'>
					<tr style='border:none;'>
						<td class='block' align='left' valign='center' style='padding:1%; border:none;' width='20%'>
						...
						<td class='block' align='center' valign='center' style='padding:1%;border:none !important;' width='40%'>
							...
							<table border='1' align='center' valign='center' role='presentation' style='border:none;width:98%;margin-bottom: 10px;background:white;color:black; margin:5px auto;{$rounded_borders}'>
								<tr style='border:none;border-bottom:solid 1px black;'>
									<td align='center' valign='center' style='padding:1%;border:none;'>
										<p style='font-weight:bold;font-size:1.3rem;line-height:2rem;margin:0;padding:30px 20px;line-height:2rem;' height='100%'>
				...
				<table cellpadding='0' cellspacing='0' border='0' align='center' role='presentation' style='width:100%;border:solid 1px white;{$rounded_borders}background:{$colors['bg-light']}; margin:5px auto'>
					<tr style='border:none;'>
						<td class='block' align='left' valign='center' style='padding:1%;font-weight:bold;font-size:1.4rem;; border:none;' width='60%'>
							<span style='display:block;line-height:2rem;background:white;color:{$colors['bg-dark']};{$rounded_borders}padding:1%;'>
								En este momento tienes <span style='color:black'>{$musculo_kg}</span> kg. de músculo.
							</span>
							<span style='display:block;line-height:2rem;padding:1%;'>
							...
							<span style='display:block;line-height:2rem;padding:1%;'>
								Tu gasto diario de calorías es: <span style='background:white;color:{$colors['bg-dark']};{$rounded_borders}padding:1%;'>{$calorias}</span>
							</span>
						</td>
